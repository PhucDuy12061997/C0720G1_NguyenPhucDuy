package com.example.case_study_furama_spring.controller;
...
public class CustomerController {
    ...
    public String createNewCustomer(RedirectAttributes redirectAttributes,
                                    ...
                                    @PageableDefault(size = 2) org.springframework.data.domain.Pageable pageable, Model model,
                                    @RequestParam Optional<String> keyword, @RequestParam Optional<String> sortBy) {
        boolean check = false;
    ...
    private void loadList(Model model, @PageableDefault(size = 2) org.springframework.data.domain.Pageable pageable,
                          @RequestParam Optional<String> keyword, @RequestParam Optional<String> sortBy) {
        String keywordOld = "";
